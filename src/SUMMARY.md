...
- [USB Serial](./usb-serial/index.md)
    ...
    - [Code with rp-hal](./usb-serial/code-with-rp-hal.md)
- [SPI](spi/index.md)
    - [SPI in Rust Ecosystem](./spi/spi-and-rust.md)
    - [In RP2350](./spi/spi-in-raspberry-pi-pico-2.md)
...
- [Joystick](./joystick/index.md)
    ...
    - [Print ADC Values](./joystick/print-adc-values.md)
        - [Using rp-hal](./joystick/adc-values-to-ubs-serial.md)
